...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    beautyAuthUserSubject.add(
      BeautyAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<BeautyAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  BeautyAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = BeautyAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    beautyAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
